...
nnplayer = DirectPolicyAgent("QLearner1", win_value=10.0, loss_value=-10.0, learning_rate=0.001)
...
game_number, p1_wins, p2_wins, draws = evaluate_players(rndplayer, nnplayer, num_battles=100, writer=writer)  # , num_battles = 20)
